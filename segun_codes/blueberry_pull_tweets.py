...
hashtags = ["#AirPollution","#airquality","#cleanair","#airpollution","#pollution","#hvac","#airpurifier" ,"#indoorairquality","#air",
"#climatechange","#indoorair","#environment" ,"#airconditioning","#heating" , "#freshair", "#airfilter","#ventilation","#airconditioner","#airqualityindex", 
"#pm2_5 ","#emissions","#natureishealing","#nature","#pollutionfree" ,"#wearethevirus",'AirPollution', 'Environment', 'Ozone Layer', 'Global Warming', 'Climate Change', 'Greenhouse Gases', 'Trees', 'Carbon',
...
for location in locations:
  ...
  for hashtag in hashtags:
    tweets = acquireTweets.getTweets(location=location,hashtag=hashtag,startDate="2020-09-01",endDate="2020-09-10")
    df.append(tweets)
...
final_df.to_csv(f'{root_path}/datasets/tryout.csv', columns=self.cols, index=False, encoding="utf-8")